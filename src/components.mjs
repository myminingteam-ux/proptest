...
import { logoSrc } from './logo-data.mjs';
...
export function footer() {
  return `<footer class="site-footer">
    <div class="wrap footer-main">
      <div class="footer-brand"><img src="${logoSrc}" alt="Your Funded Account"><p>Crypto-focused simulated trading evaluations with clear public rules.</p></div>
...
export function layout({ seo, path='/', body, schemas=[] }) {
  ...
  return `<!doctype html><html lang="en"><head>
    ...
    <link rel="stylesheet" href="/assets/styles.css"><link rel="stylesheet" href="/assets/premium.css?v=20260822-black4"><link rel="stylesheet" href="/assets/chrome.css?v=20260822-1">${schemaHtml}
