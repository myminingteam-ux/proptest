...
export function header(activePath='') {
  ...
  return `<header class="site-header">
    <div class="wrap nav">
      <a class="brand" href="/" aria-label="Your Funded Account home"><img src="/assets/yfa-logo-transparent.svg" alt="Your Funded Account"></a>
...
export function footer() {
  return `<footer class="site-footer">
    <div class="wrap footer-main">
      <div class="footer-brand"><img src="/assets/yfa-logo-transparent.svg" alt="Your Funded Account"><p>Crypto-focused simulated trading evaluations with clear public rules.</p></div>
...
export function layout({ seo, path='/', body, schemas=[] }) {
  ...
  return `<!doctype html><html lang="en"><head>
    ...
    <link rel="stylesheet" href="/assets/styles.css"><link rel="stylesheet" href="/assets/premium.css?v=20260822-black3">${schemaHtml}
