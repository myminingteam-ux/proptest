...
export function layout({ seo, path='/', body, schemas=[] }) {
  ...
  return `<!doctype html><html lang="en"><head>
    ...
    <meta name="theme-color" content="#e8edf3"><title>${escapeHtml(seo.title)}</title>
    ...
    <link rel="stylesheet" href="/assets/styles.css"><link rel="stylesheet" href="/assets/premium.css">${schemaHtml}
